...
# this class was not written by use and only used to use the yellowfin optimization algorithm. The original code base
# can be found under https://github.com/JianGoForIt/YellowFin (31.7.2018)
